...
function make_fingerprint(s::String)::Vector{Float64}
    ...
    fp_str_morgan = get_morgan_fp(mol, Dict{String,Any}("radius" => 5, "nbits" => 1024)) # 2048 by default
    fp_str_pattern = get_pattern_fp(mol, Dict{String,Any}("radius" => 7, "nbits" => 1024)) # 2048 by default
